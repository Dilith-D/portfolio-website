...
title: "Pulseboard"
description: "Pulseboard is a personal work-tracking tool for product managers built by Dilith Dinesh — daily activity logging, effort distribution visualizations, and AI-generated performance summaries."
...
schema:
  ...
  description: "A personal work-tracking and reflection tool for product managers, built by Dilith Dinesh. Surfaces effort distribution patterns and generates AI-powered performance summaries from daily activity logs. Built with Lovable and Supabase."
  author:
    "@type": "Person"
    name: "Dilith Dinesh"
    url: "https://dilithdinesh.com"
  datePublished: "2025"
  url: "https://dilithdinesh.com/projects/pulseboard"
---
