...
description: "Why Spotify Wrapped became an annual cultural ritual while imitators fail — an analysis of narrative architecture, identity-based engagement, and the interpretation layer most products miss."
...
schema:
  ...
  "@type": "Article"
  headline: "How Spotify Turned Usage Data Into an Annual Identity Ritual"
  author:
    "@type": "Person"
    name: "Dilith Dinesh"
    url: "https://dilithdinesh.com"
  datePublished: "Dec 2025"
  url: "https://dilithdinesh.com/writing/spotify-wrapped"
  description: "Why Spotify Wrapped became an annual cultural ritual while imitators fail — an analysis of narrative architecture, identity-based engagement, and the interpretation layer most products miss."
  publisher:
    "@type": "Person"
    name: "Dilith Dinesh"
...
import WrappedArc from '../../components/diagrams/WrappedArc.astro';
import WrappedInterpretation from '../../components/diagrams/WrappedInterpretation.astro';
