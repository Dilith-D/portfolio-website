...
description: "How Dilith Dinesh prototyped a multi-tenant booking widget for roofing contractors in hours — compressing a product prioritization decision from weeks to days at Zuper."
...
schema:
  ...
  "@type": "TechArticle"
  headline: "The Stopgap That Knew Its Place"
  author:
    "@type": "Person"
    name: "Dilith Dinesh"
    url: "https://dilithdinesh.com"
  datePublished: "2024"
  url: "https://dilithdinesh.com/work/booking-stopgap"
  description: "How Dilith Dinesh prototyped a multi-tenant booking widget for roofing contractors in hours — compressing a product prioritization decision from weeks to days at Zuper."
...
<MetricsSummary metrics={[
  { number: "1", label: "Feature back on roadmap" },
  { number: "Hours", label: "Decision made, not weeks" },
  { number: "4", label: "Booking modes defined" }
]} />
