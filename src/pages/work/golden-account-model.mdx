...
<MetricsSummary metrics={[
  { number: "30+", label: "Roofing contractor accounts onboarded via the golden account template" },
  { number: "15 days", label: "Onboarding time at the fast end — down from 12–16 weeks" },
  { number: "3 months", label: "From CPQ workaround to native feature shipped" }
]} />
