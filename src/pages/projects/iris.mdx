...
title: "Iris"
description: "Iris is a cross-device private file and message transfer app built by Dilith Dinesh. Multi-tenant architecture, 8-character device codes, built with React 18, TypeScript, and Supabase."
...
schema:
  ...
  description: "A cross-device private file and message transfer app built by Dilith Dinesh. Solves multi-device file transfer without platform lock-in, using 8-character device codes, multi-tenant architecture, and session-based connections. Built with React 18, TypeScript, and Supabase."
  author:
    "@type": "Person"
    name: "Dilith Dinesh"
    url: "https://dilithdinesh.com"
  datePublished: "2026"
  url: "https://dilithdinesh.com/projects/iris"
---
...
The stack was React 18, TypeScript, Supabase for the backend, and Lovable to accelerate the build. The core mechanic was an 8-character private code instead of a phone number or email — you share the code, the other device enters it, you're connected. Files stored as signed URLs. No persistent storage beyond what you explicitly sent.
...
**Persistent connections.** Connections stay active until you remove them. The alternative — auto-expiry — created friction that didn't serve the use case. If I trust you enough to pair with you, that trust doesn't have an expiry date.
